...
view_mode = st.radio(
    "View Mode",
    ["🔍 View one sector", "Compare all sectors", "🌍 Overlay everything"]
)
...
if view_mode == "🔍 View one sector":
...
elif view_mode == "🌍 Overlay everything":
    ...
    plot_df = df[df['Scenario'] != "Historical"]  # keep clean by skipping historical here
